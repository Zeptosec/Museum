<template>
    <div class="relative bg-secondary rounded-xl group max-w-xl mx-auto w-full overflow-hidden glow">
        <NuxtLink v-if="edit" :to="`/museum/${props.museumId}/category/${props.item.categoryId}/item/${props.item.id}/edit`"
        ...
        <NuxtLink :to="`/museum/${props.museumId}/category/${props.item.categoryId}/item/${props.item.id}`">
